...
Clone the repository:git clone https://github.com/rishavkr000/design-inspiration-backend.git
...
Set up environment variables in .env:DATABASE_URL=your_mongodb_url
